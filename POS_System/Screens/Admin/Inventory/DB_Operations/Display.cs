    ...
    internal class Display : IDisposable
    {
        ...
        public DataTable Display_query()
        {
            try
            {
                ...
                adapt = new SqlDataAdapter("select ProdID [PID], PCode, Manufactor [Brand], Model, Full_Name [Full Name], Price, Category, Description, Year, Warranty, Quantity, Reorder [Reorder Level], Dealer  from Product", connectionOBJ.GetConn());
                _ = adapt.Fill(dt);
                return dt;
